...
3. Rename the binary to `guacone`, mark it executable if necessary, and add it
   to your shell's path.

4. Download the compose files from the
...
5. Untar the compose files and change to that directory. (the rest of the steps
...
6. Optional: If you want test data to use,
